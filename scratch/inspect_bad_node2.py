...
out = []
node = data['sequence'][5]['branches']['b2c_consult'][3]['branches']['true'][0]['sequence'][4]['branches']['true'][6]
...
with open(r'C:\Users\Administrator\Desktop\Hoc_python\scratch\inspect_bad_node2.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(out))
